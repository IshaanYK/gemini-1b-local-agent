"""
memory_manager.py — Multi-Tier Personalization & Long-Term Memory Engine for Gemini (B1)
...
PROFILE_FILE = os.path.join(_BASE_DIR, "user_profile.json")
MEMORY_DB = os.path.join(_BASE_DIR, "long_term_memory.db")
